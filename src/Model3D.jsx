...
function PulsingHeart({ hr, playing }) {
  ...
  return <group ref={ref} position={[0, 0.6, 0]}>
    <mesh position={[-0.28, 0.25, 0]} scale={[0.42, 0.48, 0.36]}><sphereGeometry args={[1, 32, 20]} /><meshStandardMaterial color="#b94658" roughness={0.5}/></mesh>
    <mesh position={[0.28, 0.25, 0]} scale={[0.42, 0.48, 0.36]}><sphereGeometry args={[1, 32, 20]} /><meshStandardMaterial color="#b94658" roughness={0.5}/></mesh>
    <mesh position={[0, -0.05, 0]} scale={[0.56, 0.75, 0.42]} rotation={[0,0,-0.12]}><sphereGeometry args={[1, 32, 20]} /><meshStandardMaterial color="#8f3047" roughness={0.48}/></mesh>
...
function Anatomy({ hr, playing }) { return <group>
  ...
  <mesh position={[0,1.65,0]}><cylinderGeometry args={[.13,.16,1.45,18]}/><meshStandardMaterial color="#a94253"/></mesh>
